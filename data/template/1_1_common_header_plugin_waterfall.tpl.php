...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1341453697, '1', './data/template/1_1_common_header_plugin_waterfall.tpl.php', './template/default', 'common/header_plugin_waterfall')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1341453697, '1', './data/template/1_1_common_header_plugin_waterfall.tpl.php', './template/default', 'common/header_plugin_waterfall')
;?>
