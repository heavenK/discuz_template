...
0
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_setting.htm', 1341453734, '1', './data/template/1_1_portal_portalcp_block.tpl.php', './template/default', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_thumbsetting.htm', 1341453734, '1', './data/template/1_1_portal_portalcp_block.tpl.php', './template/default', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_setting.htm', 1341453734, '1', './data/template/1_1_portal_portalcp_block.tpl.php', './template/default', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_thumbsetting.htm', 1341453734, '1', './data/template/1_1_portal_portalcp_block.tpl.php', './template/default', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_nav.htm', 1341453734, '1', './data/template/1_1_portal_portalcp_block.tpl.php', './template/default', 'portal/portalcp_block')
...
var openTitle = 0;
drag.setClose();
x.get('portal.php?mod=portalcp&ac=block&op=getblock&bid='+bid+'&tpl=<?php echo $_GET['tpl'];?>&inajax=1<?php if($_GET['from']) { ?>&from=<?php echo $_GET['from'];?><?php } ?>', function(s) {
