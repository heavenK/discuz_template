...
require_once dirname(__FILE__). "/oauth2_0.class.php";
 ...
 * @version $Id: weibo.class.php 974 2011-09-20 07:32:41Z yaoying $
 *
 */
class weibo2_0
 {
	...
	/// 指定USER TOKEN
	function setTempToken($access_token, $oauth_token_secret = NULL){
	...
	{	
		...
		$tk = $sess->getToken();
		//var_dump($tk);exit;
		if (!empty($tk['oauth_token'])) {
            $this->token = $tk['oauth_token'];
        }
        if (!empty($tk['uid'])) {
            $this->uid = $tk['uid'];
        }
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/statuses/public_timeline.'.$this->format;
		$params = array();
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/statuses/home_timeline.'.$this->format;
		$params = array();
		if ($since_id) {
	 ...
	 */
	 function getUserTimeline($id = null, $user_id = null, $name = null, $since_id = null, $max_id = null, $count = null, $page = null, $useType = true)
	 {
		...
		$url = XWB_API_URL_20.'2/statuses/user_timeline.'.$this->format;
	 ...
	 {
		$url = XWB_API_URL_20.'2/statuses/mentions.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/comments/timeline.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/comments/by_me.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/comments/show.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/statuses/count.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/remind/unread_count.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/statuses/show/'.$id.'.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/statuses/update.'.$this->format;
	 ...
	 {
		$url = XWB_API_URL_20.'2/statuses/upload.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/statuses/destroy/'.$id.'.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/statuses/repost.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/comments/create.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/comments/destroy.'.$this->format;
	 ...
	 {
		$url = XWB_API_URL_20.'2/comments/reply.'.$this->format;
	...
	{ 
		$url = XWB_API_URL_20.'2/users/show.'.$this->format;
	 ...
	 * @return array|string
	 */
	 function getFriends($id = null, $user_id = null, $name = null, $page = null, $count = null, $useType = true)
	 {
		 
		$url = XWB_API_URL_20.'2/statuses/friends_timeline.'.$this->format;
		

		$params = array();
		if ($user_id) {
			$params['since_id'] = $user_id;
			$params['max_id'] = $user_id;
		} 
		if ($page) {
			$params['page'] = $page;
		}
	 ...
	 * @return array|string
	 */
	 function getFollowers($id = null, $user_id = null, $name = null, $page = null, $count = null, $useType = true)
	 {
	 ...
	 */
	 function createFriendship($id = null, $user_id = null, $name = null, $follow = null, $useType = true)
	 {
		...
		$url = XWB_API_URL_20.'2/friendships/create.'.$this->format;
	 ...
	 */
	 function deleteFriendship($id = null, $user_id = null, $name = null, $useType = true)
	 {
		...
		$url = XWB_API_URL_20.'2/friendships/destroy.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/friendships/followers.'.$this->format;
	 ...
	 */
	 function getFriendship($target_id = null, $target_screen_name = null, $source_id = null, $source_screen_name = null, $useType = true)
	 {
		...
		if ($target_screen_name) {
			$params['screen_name'] = $target_screen_name;
		} 
		$response = $this->oAuthRequest($url, 'get', $params, $useType);
	 ...
	 */
	 function getFriendIds($id = null, $user_id = null, $name = null, $cursor = null, $count = null, $useType = true)
	 {
		...
		$url = XWB_API_URL_20.'2/friendships/friends/ids.'.$this->format;
	 ...
	 */
	 function getFollowerIds($id = null, $user_id = null, $name = null, $cursor = null, $count = null, $useType = true)
	 {
		...
		$url = XWB_API_URL_20.'2/friendships/followers/ids.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/account/rate_limit_status.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/account/end_session.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/favorites.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/favorites/create.'.$this->format;
	 ...
	 */
	 ...
	 {
		$url = XWB_API_URL_20.'2/favorites/destroy.'.$this->format;
	 ...
	 /*
	 * 通过微博（评论、私信）ID获取其MID
	 * @param id	true	int64	需要查询的微博（评论、私信）ID，批量模式下，用半角逗号分隔，最多不超过20个。
	 * @param type	true	int	获取类型，1：微博、2：评论、3：私信，默认为1。
	 * @return array
	 **/
	 function querymid($id,$type=1,$useType = true)
	 { 
	 	$url = XWB_API_URL_20.'2/statuses/querymid.'.$this->format;
     ...
     * @ignore
     */
    function accessTokenURL()  { return XWB_API_AUTH_URL.'oauth2/access_token'; }
     
    /**
     * @ignore
     */
    function authorizeURL()    { return XWB_API_AUTH_URL.'oauth2/authorize'; }
	...
	{ 
        $token['oauth_token'] = "test";
        $token['oauth_token_secret'] = "test";
        return $token;
    }
    ...
    function getAuthorizeURL($token, $sign_in_with_Weibo = TRUE , $url)
	{
        if (is_array($token)) {
	 	...
	 	return $this->authorizeURL() . "?client_id=".XWB_APP_KEY."&redirect_uri=" . urlencode($url); 
	...
	function searchUser($params, $useType = true)
	{
		...
		$url = XWB_API_URL_20.'2/search/suggestions/users.'.$this->format;
		$response = $this->oAuthRequest($url, 'get', $params, $useType);
	...
	{
		$url = XWB_API_URL_20.'2/search/suggestions/statuses.'.$this->format;
		$params = array();
		if ($q) {
			$params['q'] = $q;
		} 
	...
	{
		$url = XWB_API_URL_20.'Location/citycode.'.$this->format;
		$params = array();
