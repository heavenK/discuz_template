...
if($_GET['from'] == 'portal') {
	...
	if($_G['forum']['type'] == 'sub') {
		...
		//$navigation .= ' <em>&rsaquo;</em> <a href="'.$t_link.'">'.($_G['cache']['forums'][$fup]['name']).'</a>';//edit by kaiser
	}
	...
	$navigation .= ' <em>&rsaquo;</em> <a href="'.$t_link.'">'.($_G['forum']['name']).'</a> <em>&rsaquo;</em> Ьћзг';
	unset($t_link, $t_name);
}
