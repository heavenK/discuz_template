...
$lang = array (
  ...
  'to_login' => '您需要先<a href="member.php?mod=logging&action=login&infloat=yes&frommessage&inajax=1&ajaxtarget=messagelogin" target="_blank" style=" color:#369;">登录</a>才能继续本操作',
  ...
  'login_before_enter_home' => '请先<a href="member.php?mod=logging&action=login&infloat=yes&handlekey=login&ajaxtarget=fwin_content_login">登录</a>后才能继续浏览',
