...
I 升级前的准备
---------------
1. 建立程序备份目录，例如 old/ 必要
2. 将原论坛所有程序移动到 old/ 目录中 必要（当导入头像时需要到old目录查找原论坛头像）
...
6. 转移用户头像（全新安装 UCenter 的用户不需要执行此步）
   a)进入 Discuz! X /uc_server/data/avatar/ 目录
   b)将所有文件移动到 独立的 UCenter 目录  /uc_server/data/avatar/
