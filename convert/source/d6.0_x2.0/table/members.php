...
$table_target_uc_member = $db_target->tablepre.'ucenter_members';
$table_target_uc_memberfields = $db_target->tablepre.'ucenter_memberfields';
...
if($start == 0) {
	...
	$db_uc->query("TRUNCATE $table_target_uc_memberfields");
}
